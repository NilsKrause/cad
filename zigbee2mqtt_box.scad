...
YAPPgenerate();
// pcb_length(pcb); // Front to back
// pcb_width(pcb); // Side to side
translate([pcb_length(pcb)/2+wallThickness+paddingLeft, pcb_width(pcb)/2+wallThickness+paddingLeft, 0])
    pcb(pcb);